...
if choice == 0:
    ...
    output_file_fas = "output_FASTA.fasta"
    longitud = 140
    archivo_interes = "ORF_FASTA.fasta"
else:
    # Define los parámetros de configuración
    input_file = input('Nombre del archivo Genbank: ')
    output_file_fas = input('Nombre del archivo FASTA resultante: ')
    ...
    archivo_interes = input('Nombre del archivo FASTA correspondiente al ORF seleccionado: ')
